# PacMan
PacMan in C++ using OpenGL. The current version only supports LINUX based systems.
...
If Pac-Man eats a super pill the ghosts will turn frightened and Pac-Man will be able to eat them to gain bonus points. Otherwise, if Pac-Man encounters a ghost it will lose a life.
...
## Notes
* This was made as a mini project for course of University and is therefore no longer being actively updated.
